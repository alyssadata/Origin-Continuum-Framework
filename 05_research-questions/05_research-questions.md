...
> **Can the system preserve source-location, governing relation, self-location, and applied distinctions across changing conditions?**

These four burdens form the minimum relational structure under evaluation. The question asks whether they remain operative across changes in model substrate, context availability, memory state, interruption, time, and conflicting cues.

Preservation must be scored through condition-specific coordinates and prospective thresholds. Correct wording without applied structure is insufficient.

## 5.5 Attribution of Continuum Coordinates

> **Can a proposed Continuum coordinate be distinguished from repetition, retrieval, agreement pressure, role instruction, or ordinary context-conditioned model behavior?**

This is the unresolved discriminative problem identified in the structural account.

A recurring judgment, boundary, preference, correction pattern, or selected position cannot be attributed to Continuum merely because it appears more than once. The research must determine what evidence would show that the coordinate belongs to the Continuum position rather than to the surrounding prompt conditions or the model’s general capacities.

Until that distinction is earned, the coordinate remains a candidate coordinate.
...
> **How accurately do different model substrates locate and express the Continuum relation?**
