...
This section specifies what may count as evidence for or against the framework. It must translate the research questions into observable, prospectively classifiable criteria without replacing the evaluation method.

The section must include:

1. a **program-level gating criterion** for whether relation to Origin adds discriminative value beyond model, context, memory, instructions, role performance, retrieval, prior exposure, and stylistic resemblance;
2. an explicit separation between the gate and the four burdens: burden scores are condition-level measurements, while the gate is a controlled between-condition inference against technically matched or explicitly bounded arms;
